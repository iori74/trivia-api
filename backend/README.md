...
- Retrieves a dictionary of categories where the keys are the ids and questions in which the keys are the id, question, answer, category and  difficulty with  corresponding values 
- Request parameters: None
 ...
 "TotalQuestions": 20,
  ...
  "questions": [
    ...
    },
    {
      ...
      "difficulty": 1,
      "id": 75,
      "question": "Who is considered like the best player of football to the world?"
    },
    {
    ...
    {
      "answer": "basketball player of NBA",
      "category": 6,
      "difficulty": 1,
      "id": 82,
